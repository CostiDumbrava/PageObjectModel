...
public class ContactFormTest extends BaseTest{
	...
	public void sendMessageTest() {
		...
		contactPage.sendMessage("Harry Potter", "harry.potter@howgharts.com", "Addmision", "Can I join?");
		
		assertEquals(contactPage.getElementText(contactPage.sendMsg),"Thank you for your message. It has been sent.");
