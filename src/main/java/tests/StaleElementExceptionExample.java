...
public class StaleElementExceptionExample extends BaseTest {
	...
	public void staleExample() throws InterruptedException {
		...
		//selenium incarca in memorie un webelement care este asociat cu un id de sesiune
		...
		//Fix pentru StaleElement este reidentificarea elementului care a ramas asociat cu vechea sesiune de browser
